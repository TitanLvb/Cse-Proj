...
def register_user():
    ...
    Label(root, text="Registration Success", fg="green", font=("helvetica", 11)).pack()
...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Select Your Choice", bg="blue", width="300", height="2", font=("helvetica", 13)).pack()
