...
class MainForm(Frame):
    ...
    def createWidget(self):
        self.lblMsg = Label(self, text="Sigma Health Care", bg="PeachPuff2", width="300", height="2",
                            font=("helvetica", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam = Label(self, text="Made by:", bg="slateblue4", width="250", height="1", font=("helvetica", 13))
        self.lblTeam.pack()
        self.lblTeam1 = Label(self, text="Shubham Verma (E21CSEU0611)", bg="RoyalBlue1", width="250", height="1",
                              font=("helvetica", 13))
        self.lblTeam1.pack()
        self.lblTeam2 = Label(self, text="Vipul Singh (E21CSEU0696)", bg="RoyalBlue2", width="250", height="1",
                              font=("helvetica", 13))
        self.lblTeam2.pack()
        self.lblTeam3 = Label(self, text="Tejas Iyer (E21CSEU0660)", bg="RoyalBlue3", width="250", height="1",
                              font=("helvetica", 13))
        self.lblTeam3.pack()
        self.lblTeam4 = Label(self, text="Vaibhav (E21CSEU0674)", bg="RoyalBlue4", width="250", height="1",
                              font=("helvetica", 13))
        self.lblTeam4.pack()
...
class Login(Frame):
    ...
    def createWidget(self):
        self.lblMsg = Label(self, text="Please enter details below to login", bg="Red")
        self.lblMsg.pack()
